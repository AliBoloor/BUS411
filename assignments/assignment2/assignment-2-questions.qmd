...
This problem set is based on Lecture 7. It contains five conceptual questions on mathematical modeling of interest rates. The focus is not option valuation. The goal is to explain why short-rate models are used, when they are unnecessary, what drift and volatility assumptions mean, how arbitrage-free models differ from equilibrium models, and how volatility can be estimated from historical data.

For each question:

1. Explain the economic intuition before using formulas.
2. Be clear about what the model is trying to answer.
3. Distinguish today's observed yield curve from possible future yield curves.
4. Use concise reasoning. Do not over-mathematize.
