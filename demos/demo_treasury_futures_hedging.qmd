...
|---|---|
| Observed or supplied | Positions, CTD price, conversion factor, and futures price |
| Estimated | Treasury yield betas and CTD-based futures DV01 |
| Solved | Integer number of contracts to short |
| Diagnosed | Residual rate DV01, spread risk, and rounding error |
| Used for | Before-and-after hedge P&L under a joint rate/spread shock |
