...
## The fixed-income market: a course roadmap {.unnumbered}

Fixed-income markets connect **borrowers who need funding today** with **investors who need future payments**. A city financing a transit line and a pension fund investing for retirement payments illustrate these complementary needs. Investors differ in their horizons, liquidity needs and willingness to bear risk.

![The fixed-income market and associated course topics. Braces identify later lectures; dashed arrows show valuation feedback.](images/lec1-market-roadmap.png){#fig-lec1-market-roadmap fig-align="center" width="100%"}

**Read the map from the top down.**

- **Connect funding needs.** Borrowers receive money today in exchange for promised future payments. Investors choose contracts that fit their payment horizons and liquidity needs.
- **Distinguish issuance from trading.** Primary markets raise new funding. Secondary markets transfer existing claims between investors without providing new money to the original borrower. Dealers, platforms and settlement infrastructure support both activities.
- **Follow information into prices.** Monetary policy, inflation and borrower health change expectations about future payments and discount rates. Market prices respond, changing investors’ portfolio values and borrowers’ costs of new financing or refinancing.

**Fixed payments do not imply fixed value.**

- **Value the payments.** Prices and yields express how the market values a cash-flow stream. The yield curve compares rates across maturities and helps us understand the value of payments at different dates.
- **Measure sensitivity.** Duration and the dollar value of a one-basis-point yield change (DV01) describe how prices respond to small yield changes. Convexity captures curvature in that relationship. Later topics include nonparallel curve movements, credit spreads and embedded options.
- **Build the tools gradually.** The brace annotations identify where these ideas appear in the course. They are a roadmap, not knowledge required before this introductory lecture.

**Exposure can be constructed and reshaped.**

- **Choose the exposure.** Bond selection, portfolio weights and derivatives determine which market changes affect an investor or borrower, and by how much.
- **Hedge an existing risk.** An appropriately sized short position in bond futures can offset some of a bond portfolio’s losses when yields rise. The hedge must match the exposure, rather than simply match the face value of the bonds.
- **Express a market view.** Buying a conventional fixed-rate bond in anticipation of falling yields adds directional exposure, holding other factors constant. The same instrument can serve as a hedge or a speculative position depending on the rest of the balance sheet.
- **Recognize residual risk.** Imperfect offsets, leverage and funding needs remain important. Transferring risk does not eliminate it.
...
2. **Coupon rate and payments** – the interest rate the issuer agrees to pay each year.  The coupon rate multiplied by the principal gives the annual coupon payment.  For example, a bond with a 6 % coupon rate and a face value of \$1 000 pays \$60 in interest each year, usually in two semiannual installments.
...
Suppose a bond has a principal of \$1 000 and a coupon rate of 5 %.  The annual coupon payment is simply $5\% \times 1{,}000 = 50$.  If coupons are paid semiannually, the investor receives \$25 every six months.  This illustrates how the coupon rate and principal determine the bond’s cash flow pattern.
:::
...
![Repo market: exchange of cash and collateral](images/lec1-repo-market.png){fig-align="center" width="600"}
...
- **Deferred-interest bonds**  
  Pay no coupons for an initial period, after which regular interest payments begin.

- **Step-up bonds**  
  Feature coupons that increase over time (e.g., 3% → 5% → 8%), effectively back-loading cash payments.
...
::: {.callout-note title="Example: Amortizing Bond and Weighted Average Life"}

Suppose an investor purchases a **5-year amortizing bond** with a principal of \$1,000 and equal annual repayments of principal, with interest paid separately on the outstanding balance. Unlike a non-amortizing bond—which pays all principal at maturity—this bond returns part of the principal each year along with interest.
...
**Securitization** turns a pool of loans or other income-producing assets into securities that investors can buy.  The basic idea is to connect borrowers who need financing with investors who want the cash flows from those loans.  Instead of buying an individual mortgage, an investor buys a claim on payments from a pool of mortgages.

At a broad level, the process has four steps:

1. **Originate and pool the loans.** A lender makes loans to many borrowers, then groups loans with suitable characteristics into a pool.
2. **Transfer the pool and issue securities.** The loans are typically sold to a separate trust or special-purpose vehicle (SPV), which issues securities backed by the pool.  Investors pay for those securities; the proceeds finance the purchase of the loans from the lender.  The lender can then use the cash to make new loans.
3. **Collect borrower payments.** A loan servicer collects interest and principal from borrowers and handles the administration of the loans.  The original lender may continue to perform this role even after selling the loans.
4. **Distribute the cash flows.** After servicing fees and other expenses, the cash collected is paid to investors according to the rules of the securities.  The pool's cash flows are the main source of investor payments; any guarantees or other credit protection depend on the particular structure.

### What problem does securitization solve?

Individual loans can be difficult to sell: each has its own borrower, payment history and contract terms.  A lender that holds every loan until repayment also has funds tied up for years.  Securitization provides a way to finance a pool through capital-market investors, giving the lender cash that can support further lending.  Investors gain access to loan cash flows without having to originate and administer each loan themselves.

The diagram separates **funding at issuance** from **payments over time**.  The trust sits between the lender and investors: it owns the pool and issues claims on the pool's cash flows.

![Securitization separates funding at issuance from payments over time. SPV means special-purpose vehicle.](images/lec1-securitization.png){#fig-lec1-securitization fig-align="center" width="100%"}

**What is the new asset?** The loans already exist; the newly issued securities are tradable claims on their cash flows.  Pooling can reduce exposure to any one borrower, while structuring can allocate payment timing and risk to different investor groups.  Neither step creates extra borrower income or removes common risks such as a widespread rise in defaults.

In a **mortgage pass-through**, investors generally receive a proportional share of the pool's available principal and interest payments.  More elaborate structures redistribute those same underlying cash flows:

- **CMOs** divide payments among classes called **tranches**.  For example, one tranche may receive principal repayments before another, creating securities with different expected lives and sensitivity to early repayment.  Some securitizations also give classes different priority in absorbing credit losses.
- **Stripped mortgage-backed securities** separate the cash flows into **interest-only (IO)** and **principal-only (PO)** claims.  Investors can therefore hold different exposures to the interest and principal generated by the same mortgage pool.

::: {.callout-note title="Example: From mortgage payments to investor cash flows"}

Suppose a trust holds 100 mortgages.  During one month, borrowers pay a total of \$60,000: \$40,000 of interest and \$20,000 of principal.  If servicing fees and other expenses are \$2,000, the pool has \$58,000 available for investors.  An investor owning 10% of a simple pass-through receives \$5,800, assuming no payment shortfalls or other deductions.  Part of that payment is a return of principal, so it is not all investment income.

If borrowers repay their mortgages early, investors receive principal sooner and must reinvest it.  If borrowers miss payments, cash available to investors may fall unless a guarantee or other protection covers the shortfall.  Securitization reorganizes cash flows and allocates risks among investors; it does not eliminate the risks of the underlying loans.
:::
...
Fixed‑income investing involves numerous risks. Understanding the risks below is essential for effective portfolio construction and risk control.
...
The real value of future cash flows depends on inflation.  **Inflation risk** arises when the purchasing power of a bond’s cash flows declines due to rising prices.  Inflation-linked bonds (also called **linkers**) reduce inflation risk.
...
::: {.callout-note title="Exchange Rate Risk via Carry Trade: US vs Japan"}

Suppose a Japanese investor borrows in yen at a very low interest rate and invests in a higher-yielding U.S. bond. This is a classic **carry trade**:

- Borrow in Japan at approximately 0%.
- Convert JPY to USD.
- Invest in a U.S. bond yielding approximately 5%.

If exchange rates remain stable, the investor earns the interest-rate differential (approximately 5%). However, the return depends critically on the exchange rate:

- If the **U.S. dollar depreciates** against the yen, the value of the bond’s cash flows in yen terms declines.
- Even if the bond performs well in USD terms, the investor can incur a loss after converting back to yen.

For example, suppose the exchange rate changes from 1 USD = 140 JPY to 1 USD = 120 JPY. That approximately 14% currency loss can more than offset the bond’s yield advantage.

**Key point:** For foreign-currency bonds, total return reflects both the bond return and the exchange-rate movement, and the currency component can dominate.
...
$$
\frac{5.25\%}{4} \times 1000 = \$13.125 \approx \$13.13 .
$$
...
- Major risks include **interest‑rate risk**, **reinvestment risk**, **call risk**, **credit risk** (default, **credit spread**, downgrade), **counterparty risk**, **inflation risk**, **exchange‑rate risk**, **liquidity risk**, and **volatility risk** for option‑rich bonds.
...
- Fabozzi, *Bond Markets, Analysis, and Strategies*, **Chapter 1** (overview of debt markets and debt instruments).
- [TreasuryDirect – Treasury Marketable Securities](https://www.treasurydirect.gov/marketable-securities/) — Official descriptions of Treasury bills, notes, bonds, TIPS, and floating-rate notes connect bond contract terms to securities traded in the market.
- [Federal Reserve Bank of New York – Reference Rates](https://www.newyorkfed.org/markets/reference-rates) — Official SOFR publications show how a major floating-rate benchmark is calculated and used in real contracts.
- [Bank of Canada – CORRA](https://www.bankofcanada.ca/rates/interest-rates/corra/) — The official Canadian overnight benchmark provides a direct comparison with SOFR and supports discussion of floating-rate instruments.
