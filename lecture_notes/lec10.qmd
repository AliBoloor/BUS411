...
::: {.callout-tip title="Why DTS Is Intuitive"}
...
Dividing by $\Delta y$ shows why empirical duration can differ from analytical duration:
...
The bracketed term is a duration adjustment. If Treasury yields rise when spreads tighten, then $\rho_{y,s}$ is negative. The spread tightening offsets part of the Treasury-rate price loss, so empirical duration is lower than analytical duration.
