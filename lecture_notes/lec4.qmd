...
- Fabozzi, *Bond Markets, Analysis, and Strategies*, **Chapter 5: Factors Affecting Bond Yields and the Term Structure of Interest Rates**.
- [U.S. Treasury – Interest Rate Statistics](https://home.treasury.gov/resource-center/data-chart-center/interest-rates) — Official daily par, bill, real, and long-term rates are the starting point for observing and constructing Treasury curves.
- [Federal Reserve Bank of New York – Treasury Term Premia](https://www.newyorkfed.org/research/data_indicators/term-premia-tabs) — The ACM estimates separate expected short rates from term premiums, linking yield-curve shapes to term-structure theory.
- [Federal Reserve Bank of New York – Reference Rates](https://www.newyorkfed.org/markets/reference-rates) — SOFR and related official rate publications provide the overnight foundation for modern dollar swap and forward markets.
