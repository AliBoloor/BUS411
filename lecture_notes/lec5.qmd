...
![Diagram](lec5_files/figure-latex/mermaid-figure-1.png){fig-align="center" height="380px"}
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1rem;align-items:center;width:100%;">
  <div style="min-width:0;overflow:hidden;"><img src="lec5_files/figure-latex/mermaid-figure-2.png" alt="Treasury bill cash-flow diagram" style="display:block;width:100%;height:220px;object-fit:contain;"></div>
  <div style="min-width:0;overflow:hidden;"><img src="lec5_files/figure-latex/mermaid-figure-3.png" alt="Treasury note cash-flow diagram" style="display:block;width:100%;height:220px;object-fit:contain;"></div>
  <div style="min-width:0;overflow:hidden;"><img src="lec5_files/figure-latex/mermaid-figure-4.png" alt="Treasury floating-rate note reset diagram" style="display:block;width:100%;height:220px;object-fit:contain;"></div>
</div>
:::

::: {.content-visible when-format="pdf"}
::: {layout-ncol=3}
![Treasury bill cash-flow diagram](lec5_files/figure-latex/mermaid-figure-2.png){width="100%"}

![Treasury note cash-flow diagram](lec5_files/figure-latex/mermaid-figure-3.png){width="100%"}

![Treasury floating-rate note reset diagram](lec5_files/figure-latex/mermaid-figure-4.png){height="2.2in"}
:::
:::
...
![Diagram](lec5_files/figure-latex/mermaid-figure-5.png){fig-align="center" height="380px"}
...
![Diagram](lec5_files/figure-latex/mermaid-figure-6.png){fig-align="center" height="360px"}
...
![Diagram](lec5_files/figure-latex/mermaid-figure-8.png){fig-align="center" height="360px"}
...
![Diagram](lec5_files/figure-latex/mermaid-figure-9.png){fig-align="center" height="360px"}
...
![Diagram](lec5_files/figure-latex/mermaid-figure-10.png){fig-align="center" height="340px"}
...
- [TreasuryDirect – Auction Query](https://www.treasurydirect.gov/auctions/auction-query/) — Official auction results expose issue sizes, bid-to-cover ratios, stop-out yields, and allotment details for marketable Treasuries.
- [FINRA – Fixed Income Data](https://www.finra.org/finra-data/fixed-income) — TRACE-based corporate and agency bond activity provides real-market evidence on prices, yields, volume, and liquidity.
- [SEC – EDGAR Company Filings](https://www.sec.gov/search-filings) — Issuer filings supply primary information on debt outstanding, covenants, seniority, credit risks, and financial condition.
- [Federal Reserve – Commercial Paper Rates and Outstanding Summary](https://www.federalreserve.gov/releases/cp/) — Official daily rates and outstanding amounts connect short-term corporate funding concepts to current market conditions.
