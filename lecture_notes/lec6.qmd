...
The plot has one purpose: it ranks the active bets before diversification. It tells the manager where to look first.
...
This plot has one purpose: it shows why a risk model needs correlations, not just a list of active exposures.
...
This plot has one purpose: it shows whether tracking error is mostly factor risk or mostly security-selection risk. The management response is different.
...
This plot has one purpose: it shows the sign of each active bet in a specific market move. The isolated TE plot shows size; the scenario plot shows direction.
...
This plot has one purpose: it compares where the portfolio and benchmark have their rate exposure. It is not a general "risk level" chart; it is a curve-shape diagnostic.
